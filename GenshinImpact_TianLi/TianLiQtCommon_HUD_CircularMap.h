...
#include <QWidget>
#include "ui_TianLiQtCommon_HUD_CircularMap.h"
#include <windows.h>

class TianLiQtCommon_HUD_CircularMap : public QWidget
{
	Q_OBJECT

public:
	TianLiQtCommon_HUD_CircularMap(QWidget *parent = Q_NULLPTR);
	~TianLiQtCommon_HUD_CircularMap();

private:
	Ui::TianLiQtCommon_HUD_CircularMap ui;
